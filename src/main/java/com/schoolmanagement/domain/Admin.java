...
public class Admin {
    ...
    @Column(nullable = false,unique = true,length = 25)// yazmasakta sutun olusur-Neden 3ü var:NotBlank ve Size(validation dan geliyor) mesaji yazdigi anda hatayi verir. Colums ise Db e kayitta.Gec kalinmis olur
